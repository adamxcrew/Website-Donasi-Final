                        ...
                        <tr>
                            ...
                            <td>
                                @if($programDonasi->Rekening)
                                    <a href="{{ route('relawan.rekening.show', $programDonasi->Rekening->id) }}" class="badge badge-relationship">{{ $programDonasi->Rekening->nomor_rekening ?? '' }}</a>
                                @endif
                            </td>
                            <td>
                                {{ $programDonasi->judul }}
                            ...
                            <td>
                                <div class="flex justify-end">
                                        <a class="btn btn-sm btn-info mr-2" href="{{ route('relawan.program-donasi.show', $programDonasi) }}">
                                            Lihat
                                        </a>
                                        <a class="btn btn-sm btn-success mr-2" href="{{ route('relawan.program-donasi.edit', $programDonasi) }}">
                                            Ubah
                                        </a>
