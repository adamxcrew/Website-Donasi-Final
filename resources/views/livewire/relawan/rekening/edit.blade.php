<form wire:submit.prevent="submit" class="pt-8">
    ...
    <div class="form-group {{ $errors->has('rekening.bank_id') ? 'invalid' : '' }}">
        ...
        <div class="help-block">
            {{ trans('cruds.rekening.fields.bank_helper') }}
        </div>
    </div>
    <div class="form-group {{ $errors->has('rekening.atas_nama') ? 'invalid' : '' }}">
        ...
        <div class="help-block">
            {{ trans('cruds.rekening.fields.atas_nama_helper') }}
        </div>
    </div>
    <div class="form-group {{ $errors->has('rekening.nomor_rekening') ? 'invalid' : '' }}">
        ...
        <div class="help-block">
            {{ trans('cruds.rekening.fields.nomor_rekening_helper') }}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <a href="{{ route('relawan.rekening.index') }}" class="btn btn-secondary">
            Batal
        </a>
    </div>
</form>
