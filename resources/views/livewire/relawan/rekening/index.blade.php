                ...
                <tbody>
                    @forelse($rekenings as $rekening)
                        <tr>
                            ...
                            <td>
                                @if($rekening->Bank)
                                    <a class="badge badge-relationship">{{ $rekening->Bank->nama ?? '' }}</a>
                                @endif
                            </td>
                            <td>
                                {{ $rekening->atas_nama }}
                            ...
                            <td>
                                <div class="flex justify-end">
                                        <a class="btn btn-sm btn-info mr-2" href="{{ route('relawan.rekening.show', $rekening) }}">
                                            Lihat
                                        </a>
                                        <a class="btn btn-sm btn-success mr-2" href="{{ route('relawan.rekening.edit', $rekening) }}">
                                            Ubah
                                        </a>
