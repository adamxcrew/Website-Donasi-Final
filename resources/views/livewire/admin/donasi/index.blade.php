                        ...
                        <tr>
                            ...
                            <td>
                                @if($donasi->ProgramDonasi)
                                    <a href="{{ route('admin.program-donasi.show', $donasi->ProgramDonasi->id) }}" class="badge badge-relationship">{{ $donasi->ProgramDonasi->judul ?? '' }}</a>
                                @endif
                            </td>
                            <td>
                                {{ $donasi->nama_donatur }}
                            ...
                            <td>
                                <div class="flex justify-end">
                                    @can('donasi_show')
                                        <a class="btn btn-sm btn-info mr-2" href="{{ route('admin.donasi.show', $donasi) }}">
                                            Lihat
                                        </a>
                                    @endcan
                                    @can('donasi_edit')
                                        <a class="btn btn-sm btn-success mr-2" href="{{ route('admin.donasi.edit', $donasi) }}">
                                            Ubah
                                        </a>
                                    @endcan
                                    @can('donasi_delete')
