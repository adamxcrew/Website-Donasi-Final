                            ...
                            <td>
                                <div class="flex justify-end">
                                    @can('program_berita_show')
                                        <a class="btn btn-sm btn-info mr-2" href="{{ route('admin.program-berita.show', $programBerita) }}">
                                            Lihat
                                        </a>
                                    @endcan
                                    @can('program_berita_edit')
                                        <a class="btn btn-sm btn-success mr-2" href="{{ route('admin.program-berita.edit', $programBerita) }}">
                                            Ubah
                                        </a>
                                    @endcan
                                    @can('program_berita_delete')
